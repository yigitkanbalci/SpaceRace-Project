...
void update_ast(int x, int y, int overlay);
void update_astfast(int x, int y, int overlay);
void update_astfaster(int x, int y, int overlay);
...
extern const Picture space; // A 240x320 space image
extern const Picture spaceship; // A 19x19 purple ball with white boundaries
extern const Picture asteroidpic;
